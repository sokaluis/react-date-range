...
function DateDisplay({ focusedRange = [0, 0], color, ranges = [], rangeColors = [], dateDisplayFormat, editableDateInputs, startDatePlaceholder, endDatePlaceholder, ariaLabels = {}, minDate, maxDate, disabledDates = [], onChange, onRangeFocusChange, dateOptions, styles = {} }) {
	...
	return /* @__PURE__ */ react.default.createElement("div", {
		...
		return /* @__PURE__ */ react.default.createElement("div", {
			...
			className: (0, classnames.default)(styles.dateDisplayItem, { [styles.dateDisplayItemActive]: focusedRange[0] === i && focusedRange[1] === 0 }),
			...
			maxDate,
			disabledDates
		}), /* @__PURE__ */ react.default.createElement(require_components_DateInput_index, {
			className: (0, classnames.default)(styles.dateDisplayItem, { [styles.dateDisplayItemActive]: focusedRange[0] === i && focusedRange[1] === 1 }),
			readOnly: !editableDateInputs,
			disabled: range.disabled,
			value: range.endDate,
