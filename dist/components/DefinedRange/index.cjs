...
const DefinedRange = (0, react.forwardRef)((props, ref) => {
	...
	return /* @__PURE__ */ react.default.createElement("div", { className: (0, classnames.default)(require_styles.definedRangesWrapper, className) }, headerContent, /* @__PURE__ */ react.default.createElement("div", { className: require_styles.staticRanges }, staticRanges.map((staticRange, i) => {
		...
		return /* @__PURE__ */ react.default.createElement("button", {
			...
			className: (0, classnames.default)(require_styles.staticRange, { [require_styles.staticRangeSelected]: Boolean(selectedRange) }),
			...
			tabIndex: -1,
			className: require_styles.staticRangeLabel
		}, labelContent));
	})), /* @__PURE__ */ react.default.createElement("div", { className: require_styles.inputRanges }, inputRanges.map((rangeOption, i) => /* @__PURE__ */ react.default.createElement(require_components_InputRangeField_index, {
		key: i,
