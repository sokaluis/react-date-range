...
**Goal**: Verify that importing `react-date-range-modern` in Node.js does NOT crash
...
npm install      # symlinks react-date-range-modern -> ../..
```
...
`import "react-date-range-modern/styles.css"` is a **bundler-only** import, not a
